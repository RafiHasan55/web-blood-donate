  ...
  return (
    <div className=" bg-[url(/bg.png)] bg-contain ">
      <div className=" bg-white bg-opacity-90 min-h-screen">
        <div className="max-w-11/12 mx-auto py-10 m-5 p-5  ">
            ...
            <div className="login-for flex-1">
              ...
              >
                ...
                <div className="flex justify-start items-center">
                  ...
                  <input
                    className="outline-none flex-1 border-b-2 p-2 bg-transparent focus:border-rede-600 transition-all  duration-200"
                    type="email"
                    name="email"
                ...
                <input
                  type="submit"
                  value="Login Now"
                  className="btn cursor-pointer bg-red-600 text-white hover:bg-red-700 rounded-md"
                />
                <p>
